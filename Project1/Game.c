...
void Draw(SDL_Renderer* renderer) {
	...
	for (size_t i = 0; i < meshCube->trisCount; i++)
	{
		...
		rotatedTriangle.t[0] = meshCube->tris[i].t[0];
		rotatedTriangle.t[1] = meshCube->tris[i].t[1];
		rotatedTriangle.t[2] = meshCube->tris[i].t[2];
	...
	for (size_t i = 0; i < triangleCount; i++)
	{
		...
		viewTriangle.t[0] = triangles[i].t[0];
		viewTriangle.t[1] = triangles[i].t[1];
		viewTriangle.t[2] = triangles[i].t[2];
